...
ax = sns.heatmap(heat_table_organised, linewidth=.5,linecolor='w', square=True, xticklabels=True,vmin=-1,vmax=3,
...
plt.title("Human")
plt.tight_layout()
# save_path = '/Users/tianxingdu/Documents/4_Software Data/6_PycharmProjects/Bioinformatics/0_1_Work/1_Metabolitenassay/0_Output/20211021_5h/colorbar_speci.pdf'
